...
public class PerfilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        double hora = 0;
        try {
            hora = new FuncionarioDAO(PerfilActivity.this).calcularHoras(funcionario.getCodigo());
